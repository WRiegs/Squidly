...
def main():
    ...
    dataset_fasta = "/scratch/project/squid/code_modular/CataloDB/All_seqs_redundancy_famtest_filtered.fasta"
    ...
    output_dir = pathlib.Path(f"CataloDB_{args.scheme}_{args.esm2_model}_{datetime.datetime.now().strftime('%Y-%m-%d')}")
    ...
    EVAL="/scratch/project/squid/code_modular/CataloDB/final_test_set_post_structural_filtering.txt"      
