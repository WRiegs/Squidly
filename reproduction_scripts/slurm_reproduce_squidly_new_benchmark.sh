...
TEST_NAME="Reproduction_Dataset_Scheme_${SCHEME}_SLIM_${SLIM}_${ESM2_MODEL}_$(date +"%Y-%m-%d_%H-%M-%S")"
...
sbatch <<- EOS
    ...
    python reproduce_squidly_new_squid_new_me.py --scheme $SCHEME --sample_limit $SLIM --reruns $REPS --esm2_model $ESM2_MODEL --ASvBS $ASvBS
