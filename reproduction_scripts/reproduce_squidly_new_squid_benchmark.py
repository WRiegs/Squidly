...
def main():
    ...
    dataset_fasta = "/scratch/project/squid/code_modular/squidly_benchmark/0.9filtered_for_redundancy.fasta"
    ...
    output_dir = pathlib.Path(f"SQUIDLY_BENCHMARK_{args.scheme}_{args.esm2_model}_{datetime.datetime.now().strftime('%Y-%m-%d')}")
    ...
    TEST=f"/scratch/project/squid/code_modular/squidly_benchmark/Structurally_filtered_eval_benchmark/empty_extra_test_validation.txt"
