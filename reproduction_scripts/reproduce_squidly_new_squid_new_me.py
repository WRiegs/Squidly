# python reproduce_squidly_AEGAN_benchmark.py --scheme 2 --sample_limit 4000 --esm2_model esm2_t36_3B_UR50D --reruns 5
# python reproduce_squidly_AEGAN_benchmark.py --scheme 2 --sample_limit 4000 --esm2_model esm2_t48_15B_UR50D --reruns 5
# python reproduce_squidly_AEGAN_benchmark.py --scheme 2 --sample_limit 12000 --esm2_model esm2_t48_15B_UR50D --reruns 5
...
def main():
    ...
    dataset_fasta = "/scratch/project/squid/code_modular/squidly_benchmark/0.9reduced_training_set_no_family_specific.fasta"
    dataset_metadata = "/scratch/project/squid/code_modular/datasets/dataset_2.tsv"
    ...
    output_dir = pathlib.Path(f"SQUIDLY_YABOMBACLAT_WATCHOUTFORTHEROAD_{args.scheme}_{args.esm2_model}_{datetime.datetime.now().strftime('%Y-%m-%d')}")
    ...
    EVAL=f"/scratch/project/squid/code_modular/squidly_benchmark/Structurally_filtered_eval_benchmark/0.3_Structural_ID_benchmark.txt"      
    LSTMOUT=f"{PSCHEME_OUT}LSTM/"
    MODEL=f"{PSCHEME_OUT}models/temp_best_model.pt"
    ASvBS="AS"
    TEST="/scratch/project/squid/code_modular/squidly_benchmark/Structurally_filtered_eval_benchmark/empty_extra_test_validation.txt"
